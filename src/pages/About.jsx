  ...
  return (
    <div className="bg-gray-100  p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-800">
          Study Notion was founded in 2023 by Aman Yadav with a vision to create an accessible platform for learning and self-improvement. Our team of experts and educators curate diverse courses tailored to meet the needs of learners worldwide.
        </p>

        <h2 className="text-2xl font-bold my-4">Our Team</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-bold mb-2">Adarsh Prjapati</h3>
            <p className="text-gray-700">Co-Founder & CTO</p>
            <p className="mt-2 text-gray-800">Adarsh is passionate about education and technology, driving our mission to make learning accessible to everyone.</p>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-md">
